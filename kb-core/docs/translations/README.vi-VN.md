...
Hoàn toàn đa phương thức. Thêm code, PDF, markdown, ảnh chụp màn hình, sơ đồ, ảnh bảng trắng, hình ảnh bằng ngôn ngữ khác hoặc tệp video và âm thanh — kb-core trích xuất các khái niệm và mối quan hệ từ tất cả mọi thứ và kết nối chúng trong một đồ thị duy nhất. Video được phiên âm cục bộ bằng Whisper. Hỗ trợ 25 ngôn ngữ lập trình qua tree-sitter AST.

> Andrej Karpathy duy trì một thư mục `/raw` nơi anh ấy đặt các bài báo, tweet, ảnh chụp màn hình và ghi chú. kb-core là câu trả lời cho vấn đề đó — **71,5x** ít token hơn trên mỗi truy vấn so với đọc các tệp thô, liên tục giữa các phiên.
...
> **Gói chính thức:** Gói PyPI có tên là `kb-core`. Kho lưu trữ chính thức duy nhất là [safishamsi/kb-core](https://github.com/safishamsi/kb-core).
...
/kb-core .
/kb-core ./raw --update
/kb-core query "điều gì kết nối Attention với optimizer?"
...
## Được xây dựng trên kb-core — Penpax

[**Penpax**](https://safishamsi.github.io/penpax.ai) là lớp doanh nghiệp trên kb_core. **Dùng thử miễn phí sắp ra mắt.** [Tham gia danh sách chờ →](https://safishamsi.github.io/penpax.ai)
