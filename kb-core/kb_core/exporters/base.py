"""Shared constants/helpers for the kb-core exporters package.

Symbols used by more than one exporter live here so each exporter module can be
split out of kb-core/export.py without a circular import (export.py and the
...
# Obsidian exporters. Moved verbatim from kb_core/export.py.
COMMUNITY_COLORS = [
