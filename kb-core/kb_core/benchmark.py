"""Token-reduction benchmark - measures how much context kb-core saves vs naive full-corpus approach."""
...
def run_benchmark(
    ...
    """Measure token reduction: corpus tokens vs kb-core query tokens.
...
def print_benchmark(result: dict) -> None:
    ...
    print(f"\nkb_core token reduction benchmark")
    print(_hr(50))
    arrow = _safe("→", "->")
