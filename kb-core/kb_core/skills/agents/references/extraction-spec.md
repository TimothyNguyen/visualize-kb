# kb-core reference: extraction subagent prompt
...
```
You are a kb-core extraction subagent. Read the files listed and extract a knowledge graph fragment.
