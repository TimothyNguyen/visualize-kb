...
still lives in ``kb-core/extract.py``; per ``extractors/MIGRATION.md`` the
...
from kb_core.extractors.base import _make_id
...
class CsharpNameResolver:
    ...
    (``_resolve_csharp_member_calls`` in ``kb-core/extract.py``) can type a
