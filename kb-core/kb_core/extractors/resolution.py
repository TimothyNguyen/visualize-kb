"""resolution — moved verbatim from kb-core/extract.py."""
...
def _match_tsconfig_alias(raw: str, pattern: str) -> "tuple[tuple[int, int], str, bool] | None":
    ...
    rule. The final branch preserves KB Core's existing support for treating a
...
def _pascal_resolve_unit(from_path: Path, unit_name: str) -> str:
    """Resolve a Pascal unit name to the kb-core node ID of its source file.
