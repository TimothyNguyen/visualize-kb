"""engine — moved verbatim from kb-core/extract.py."""
from __future__ import annotations

import hashlib
import importlib
from kb_core.extractors.base import _LANGUAGE_BUILTIN_GLOBALS, _file_stem, _make_id, _read_text
from kb_core.ids import normalize_id
from kb_core.extractors.models import LanguageConfig
from kb_core.extractors.resolution import _resolve_js_import_target
...
def _js_import_binds_external(raw: str, str_path: str) -> bool:
    ...
    Reuses `_resolve_js_import_target`, so this is kb-core's own verdict rather
