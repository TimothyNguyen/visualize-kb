...
def _read_json_file(path: str | Path) -> dict[str, Any]:
    """Read a JSON graph after applying KB Core's graph-load size cap."""
    ...
    try:
        ...
        raise RuntimeError(
            ...
            "The file may be corrupted — re-run 'kb-core extract'."
        ) from exc
...
def format_diagnostic_report(summary: dict[str, Any]) -> str:
    ...
    lines = [
        "[kb-core] MultiDiGraph edge-collapse diagnostic",
