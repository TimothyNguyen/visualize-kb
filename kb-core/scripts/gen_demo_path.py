...
Concept 1 ("The Path Lights Up"): a terminal types `kb_core path ...` on the
...
e(f'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {W} {H}" width="{W}" height="{H}" '
  ...
  f'aria-label="kb_core path query lighting up a knowledge graph">')
e('<defs>')
...
e(f'<text x="{PANEL-16}" y="34" text-anchor="end" font-size="10" fill="{TXT_DIM}">kb_core</text>')
...
cmd = 'kb_core path "FastAPI" "ModelField"'
