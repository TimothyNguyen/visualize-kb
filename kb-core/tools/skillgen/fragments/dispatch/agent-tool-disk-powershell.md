...
```powershell
$PROJECT_ROOT = (Get-Location).Path  # cwd — where Part C globs kb-core-out\ (NOT .kb_core_root/scan dir, #1392)
# Then for chunk N: $CHUNK_PATH = Join-Path $PROJECT_ROOT "kb-core-out\.kb_core_chunk_0N.json"
```
