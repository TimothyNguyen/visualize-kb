# KB Core Evaluation - Mixed Corpus (2026-04-04)
...
**Finding:** Communities are semantically correct - the three kb-core modules map cleanly
...
detect() on eval root with kb-core-out/memory/ present:
...
**What kb-core extracts (Claude vision reads directly, no reshaper/bidi needed):**
...
identically to English. The image node in kb-core is just a path - the vision subagent does
the rest.
