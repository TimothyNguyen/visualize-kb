# KB Core Evaluation - httpx Corpus (2026-04-03)
...
**Pipeline:** kb-core AST extractor + graph_builder + Leiden clusterer + analyzer + reporter
**Method:** Full deterministic code tracing of every kb-core source module against
...
```markdown
# Graph Report - /home/safi/kb-core_test/httpx  (2026-04-03)
...
The kb-core AST extractor is deterministic, fast, and accurate for what it extracts.
