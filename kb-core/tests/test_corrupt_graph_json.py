...
affected.load_graph (`kb-core prs`), and diagnostics._read_json_file
(`kb-core diagnose`). A truncated / invalid file (incomplete write, power loss,
...
from kb_core.diagnostics import _read_json_file
