...
from kb_core.affected import affected_nodes
from kb_core.extract import extract, extract_python
...
def test_cross_file_indirect_survives_id_relativization(tmp_path):
    ...
    root, as the `kb-core extract` CLI passes), the id-remap rewrites node ids
