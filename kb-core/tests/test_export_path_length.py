...
directory therefore overruns MAX_PATH, and `kb-core export obsidian` /
...
from kb_core import export as export_mod
from kb_core import wiki as wiki_mod
from kb_core.export import _obsidian_safe_stem, to_canvas, to_obsidian
from kb_core.paths import _MIN_STEM_BUDGET, _WINDOWS_MAX_PATH, stem_filename_budget
from kb_core.wiki import _safe_filename, to_wiki
...
def test_budget_shrinks_so_the_whole_path_fits_max_path(monkeypatch):
    ...
    vault = r"C:\Users\dev\projects\payments-api\kb-core-out\obsidian"
