"""Tests for the language resolver registry (kb_core.resolver_registry).
...
from kb_core.resolver_registry import (
    LanguageResolver,
...
def test_default_registry_contains_swift_then_python() -> None:
    ...
    import kb_core.extract  # noqa: F401  (registers resolvers on import)
