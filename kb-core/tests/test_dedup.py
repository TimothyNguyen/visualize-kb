"""Tests for kb-core/dedup.py entity deduplication pipeline."""
from __future__ import annotations
import pytest
from kb_core.dedup import (
...
def test_build_calls_dedup():
    ...
    from kb_core.build import build
    chunk1 = {
...
def test_dedup_still_merges_real_typos():
    ...
    from kb_core.dedup import _is_variant_pair, _short_label_blocked
...
def test_variant_pair_helper():
    ...
    from kb_core.dedup import _is_variant_pair
...
def test_prefix_guard_does_not_block_same_length_typos():
    ...
    from kb_core.dedup import _norm
...
def test_numeric_tokens_differ_helper():
    ...
    multisets (#1284)."""
    from kb_core.dedup import _numeric_tokens_differ
...
def test_content_token_swap_helper():
    ...
    from kb_core.dedup import _content_token_swap
...
def test_same_word_variant_helper():
    ...
    from kb_core.dedup import _same_word_variant
