"""Comprehensive tests for kb_core.scip_ingest."""

from __future__ import annotations

import pytest

from kb_core.scip_ingest import (
...
def test_relationship_edges_survive_validate_extraction_and_build():
    """Result passes KB Core's validate_extraction and build_from_json keeps the edges."""
