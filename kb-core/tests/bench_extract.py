...
Example output:
    === KB Core AST Extraction Benchmark ===
    Files:        1,247
...
from kb_core.extract import extract, collect_files
from kb_core.cache import clear_cache
...
def main() -> None:
    ...
    print("=== KB Core AST Extraction Benchmark ===\n")
