...
from kb_core.build import build_from_json, build, build_merge, edge_data, edge_datas, dedupe_edges, dedupe_nodes
...
def test_legacy_node_name_path_aliases_folded():
    ...
    from kb_core.validate import validate_extraction
...
def test_build_from_json_ambiguous_old_stem_alias_stays_dangling(tmp_path):
    ...
    extraction = {
        "nodes": [
            ...
            # form, matching what a real kb_core update run would already have
...
def test_merge_raw_extraction_tier_scoped(tmp_path):
    ...
    from kb_core.build import merge_raw_extraction
...
def test_graph_has_legacy_ids_detects_old_scheme():
    ...
    from kb_core.build import graph_has_legacy_ids
...
def test_semantic_rekey_relative_vs_absolute_source_file():
    ...
    from kb_core.build import _semantic_id_remap
...
def test_derive_prune_root_recovers_root_from_posix_absolute_prune_sources():
    ...
    direction.
    """
    from kb_core.build import _derive_prune_root
