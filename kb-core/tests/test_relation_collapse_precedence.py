...
kb-core's own corpus that rewrote all 144 pairs where the extraction found both
...
from kb_core.build import build_from_json, edge_data
...
def test_the_reported_case_keeps_calls():
    """The exact shape seen 144 times on kb-core's own graph."""
