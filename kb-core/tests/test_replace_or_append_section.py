"""#1688 - kb-core's shared-file section update must not destroy user content.

_replace_or_append_section used to locate its marker (`## kb-core`) as a
...
from kb_core.__main__ import _replace_or_append_section

MARKER = "## kb-core"
NEW = "## kb-core\n\nThis project has a knowledge graph at kb-core-out/.\n"
...
def test_real_section_is_replaced_in_place():
    ...
    assert "knowledge graph at kb-core-out/" in after
