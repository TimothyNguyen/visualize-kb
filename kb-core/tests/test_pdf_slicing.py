...
Papers are the longest documents anyone points kb-core at, and a compressed
...
from kb_core.llm import _FILE_CHAR_CAP, _file_to_text, _read_files

try:  # the reader this fix introduces
    from kb_core.file_slice import unit_source_text
