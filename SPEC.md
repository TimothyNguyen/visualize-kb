...
V2. Harness normalizes only declared nondeterminism: key order, line endings, fixture-root paths, timestamps, and generated IDs.
...
|T8|.|Port memory store, embedding interface, CRUD/search behavior, and bot runner behavior.|V5,V8|
|T9|.|Port REST service. Run route parity cases against Go and Python.|V5,V8|
